...
import DropDownSelect from './SmallComponents/DropDownSelect';
...
let oldAnimeId = null;
const AnimeInfo = ({navigation, route}) => {
  const {animeId, aniwatchId} = route.params;
      ...
      <FlatList
        ...
        keyExtractor={
          isLoading
            ...
            : (item, index) => `${item?.animeID}-${index}-animeIfo-related-FlatList`
        }
        renderItem={({item}) => {
          if (isLoading) {
            return (
