...
const Trailers = ({refreshing, list, isLoading, error}) => {
  ...
  const onPressAnime = item => {
    navigation.navigate('trailer-info', {
      id: item.id,
    });
  };
  ...
  return (
    <View>
      <Text style={{fontFamily:font.OpenSansBold, color:color.White, paddingVertical:5, paddingHorizontal:5}}>Trailers</Text>
      <FlatList
        ref={flatListRef}
        horizontal={true}
        data={list}
